-- =====================================================
-- 🏛️ Church Management System - Database Setup (Compatible Version)
-- =====================================================
-- This version works with existing users table structure
-- =====================================================
...
-- We'll only add tables that don't reference missing columns
...
-- =====================================================
-- 👥 MEMBER PROFILES (Dependencies on users - but flexible)
-- =====================================================

-- 10. member_profiles
CREATE TABLE IF NOT EXISTS member_profiles (
  id TEXT PRIMARY KEY DEFAULT gen_random_uuid(),
  userId TEXT, -- Remove foreign key constraint for now
...
-- 21. pastoral_care_records
CREATE TABLE IF NOT EXISTS pastoral_care_records (
  id TEXT PRIMARY KEY DEFAULT gen_random_uuid(),
  memberId TEXT, -- Remove foreign key constraint for now
  pastorId TEXT, -- Remove foreign key constraint for now
