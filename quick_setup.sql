...
CREATE TABLE users (
  ...
  role TEXT DEFAULT 'USER' CHECK (role IN ('ADMIN', 'ACCOUNTANT', 'PASTOR', 'VOLUNTEER_COORDINATOR', 'MEMBER', 'VOLUNTEER', 'STAFF', 'USER', 'MEDIA_DEPARTMENT', 'KITCHEN_RESTAURANT', 'MANAGEMENT', 'USHER_MANAGEMENT', 'PARTNERS_COORDINATOR', 'PRAYER_LINE_COORDINATOR')),
