...
router.get('/dashboard', async (req, res) => {
    try {
        ...
        const [totalVolunteers, activeVolunteers, totalPastoralCare, openPastoralCare, totalCommunications, pendingCommunications, recentAttendanceCount, recentEvents,] = await Promise.all([
        ...
        const volunteerEngagementRate = totalMembers > 0
