...
exports.memberPortalRouter = exports.volunteerCoordDashboardRouter = exports.pastorDashboardRouter = exports.accountantDashboardRouter = exports.adminDashboardRouter = void 0;
...
exports.accountantDashboardRouter.get('/stats', auth_1.authMiddleware, (0, auth_1.requireRole)(accessRoles_1.FINANCE_CORE_ROLES), async (_req, res) => {
    try {
        const monthStart = startOfMonth();
        const [budgetSum, incomeMonth, expenseSum, pending, financialRecent, expenseRecent] = await Promise.all([
...
/** /api/pastor/stats */
exports.pastorDashboardRouter = express_1.default.Router();
exports.pastorDashboardRouter.get('/stats', auth_1.authMiddleware, (0, auth_1.requireRole)(PASTOR_DASHBOARD_ROLES), async (_req, res) => {
    try {
        const weekStart = startOfWeek();
        const monthStart = startOfMonth();
        const [newMembersThisWeek, attendanceMonth, totalMembers, prayerRequests, pastoralVisits, recent] = await Promise.all([
...
/** /api/volunteer/stats */
exports.volunteerCoordDashboardRouter = express_1.default.Router();
exports.volunteerCoordDashboardRouter.get('/stats', auth_1.authMiddleware, (0, auth_1.requireRole)(VOLUNTEER_COORD_ROLES), async (_req, res) => {
    try {
        const now = new Date();
        const [activeVolunteers, ministries, totalMembers, upcomingEvents, assignments] = await Promise.all([
        ...
        const engagementRate = totalMembers > 0 ? Math.min(100, Math.round((activeVolunteers / totalMembers) * 100)) : 0;
...
//# sourceMappingURL=roleDashboards.js.map